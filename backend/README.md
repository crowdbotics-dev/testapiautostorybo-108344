...
## Project Structure
    ...
    ├── testapiautostorybo_108344  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_108344`
...
2. Clone this repo and `cd testapiautostorybo_108344`
